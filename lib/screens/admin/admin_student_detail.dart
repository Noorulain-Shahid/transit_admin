...
class _AdminStudentDetailState extends State<AdminStudentDetail>
  ...
  void initState() {
    ...
    _selectedPlan = widget.student.subscriptionPlan;
    _currentStatus = widget.student.subscriptionStatus;
  }
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        StatusBadge(
                                          label:
                                              '💳 ${_selectedPlan == null ? 'Free' : subscriptionPlanConfigs[_selectedPlan]!.name}',
                                          color: _selectedPlan == null
                                              ? const Color(0xFF94A3B8)
                                              : subscriptionPlanConfigs[_selectedPlan]!
                                                    .color,
                                        ),
                                      ],
                                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _SubscriptionInfoRow(
                                label: 'Amount Due',
                                value:
                                    'Rs${subscriptionPlanConfigs[_selectedPlan ?? SubscriptionPlan.free]!.price.toInt()}',
                                color: AppTheme.warning,
                              ),
                              _SubscriptionInfoRow(
                                label: 'Days Overdue',
                                value: '${s.overdueDays} days',
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  Expanded(
                                    child: _ActionBtn(
                                      ...
                                      onTap: () => _msg('Location update form'),
                                    ),
                                  ),
                                  const SizedBox(width: 8),
                                  Expanded(
                                    child: _ActionBtn(
                                      ...
                                      onTap: () => _msg('Delete confirmation'),
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              GlassCard(
                                ...
                                borderColor: AppTheme.error.withValues(
                                  alpha: 0.15,
                                ),
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Enable manual emergency access override',
                                            style: TextStyle(
                                              color: context.textSecondary,
                                              fontSize: 11,
                                            ),
  ...
  Widget _buildAttendance(BuildContext context) {
    final items = [
      ('May 26', 'Present', AppTheme.success),
      ('May 25', 'Present', AppTheme.success),
      ('May 24', 'Absent', AppTheme.error),
      ('May 23', 'Present', AppTheme.success),
      ('May 22', 'Late', AppTheme.warning),
    ];
    return ListView(
  ...
  Widget _buildTripHistory(BuildContext context) {
    final items = [
      ('May 26', 'Route A — Completed', AppTheme.success),
      ('May 25', 'Route A — Completed', AppTheme.success),
      ('May 24', 'Route A — Missed', AppTheme.error),
      ('May 23', 'Route A — Completed', AppTheme.success),
    ];
    return ListView(
      padding: const EdgeInsets.only(top: 12),
      children: items
  ...
  Widget _buildMissedLogs(BuildContext context) {
    final items = [
      ('May 24', 'Missed pickup — no show at stop', AppTheme.error),
      ('May 18', 'Missed drop — parent picked up early', AppTheme.warning),
    ];
    return ListView(
      padding: const EdgeInsets.only(top: 12),
      children: items
