...
final mockStudents = [
  const StudentRecord(
    ...
    pickupTime: '07:10 AM',
    dropTime: '02:30 PM',
    pickupLocation: 'North Colony Stop #2',
    dropLocation: 'Lincoln Elementary',
  ),
  const StudentRecord(
    id: 'stu_2',
    name: 'Emma Watson',
    ...
    pickupTime: '07:25 AM',
    dropTime: '02:45 PM',
    pickupLocation: 'Civic Center Stop',
    dropLocation: 'Maple School',
  ),
  const StudentRecord(
    id: 'stu_3',
    name: 'Ali Hassan',
  ...
  const StudentRecord(
    ...
    pickupTime: '07:30 AM',
    dropTime: '02:50 PM',
    pickupLocation: 'West Town Stop',
    dropLocation: 'City School',
  ),
  const StudentRecord(
    id: 'stu_5',
    name: 'Haya Shahid',
  ...
  const StudentRecord(
    ...
    pickupTime: '07:20 AM',
    dropTime: '02:00 PM',
    pickupLocation: 'Model Town Stop',
    dropLocation: 'National School',
  ),
];
